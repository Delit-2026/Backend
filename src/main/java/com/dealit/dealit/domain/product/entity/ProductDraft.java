...
@SequenceGenerator(
	name = "product_draft_seq_generator",
	sequenceName = "product_draft_seq",
	allocationSize = 1
)
public class ProductDraft extends BaseEntity {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "product_draft_seq_generator")
	...
	public static ProductDraft create(
		...
		return new ProductDraft(name, description, saleType, categoryId, memberId, price, allowOffer, location, payloadJson, savedAt);
	}
